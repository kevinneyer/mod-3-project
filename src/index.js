        ...
        <div class="card-body">
          ...
          <form id="comment-form">
            <div class="form-group">
              <input id="new-comment" type="text" name="comment" class="form-control" placeholder="New Comment">
    ...
    if (e.target.id === "create") {
      ...
      <fieldset>
        ...
        <div class="form-group">
          ...
          <input type="text" name="name" class="form-control" id="DrinkName"  placeholder="What do you call your cocktail?">
        </div>
        <div class="form-group">
          <label for="Ingredient1">First Ingredient</label>
          <input type="text" name="ingredient1" class="form-control" id="Ingredient1" placeholder="First ingredient...">
        </div>
        <div class="form-group">
          <label for="Ingredient2">Second Ingredient</label>
          <input type="text" name="ingredient2" class="form-control" id="Ingredient2" placeholder="Second ingredient...">
        </div>
        <div class="form-group">
          <label for="Ingredient3">Third Ingredient</label>
          <input type="text" name="ingredient3" class="form-control" id="Ingredient3" placeholder="Third ingredient...">
        </div>
        <div class="form-group">
          <label for="exampleTextarea">Bio</label>
          <small class="form-text text-muted">Short and sweet.</small>
        ...
        <div class="form-group">
          ...
          <small class="form-text text-muted">Click below to see your creation.</small>
        </div>
      </fieldset>
      <fieldset>
...
function submitForm() {
  document.addEventListener("submit", function(e){
    if (e.target.id === "drink-form"){
      ...
      fetch("http://localhost:3000/cocktails", configObj)
      .then(response => response.json())
      .then(cocktail => {
        renderCocktail(cocktail)
        renderIngredients(cocktail)
